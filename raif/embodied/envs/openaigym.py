...
Description: This file contains pointer to original gym env
"""
...
class GymEnv(embodied.Env):
  ...
  def __init__(self, env, obs_key='state', act_key='action', **kwargs):
  ...
  def step(self, action):
    ...
    obs, reward, done, self._info = self._env.step(action)
    self._done = done
    return self._obs(
        obs, reward,
        is_first=False,
