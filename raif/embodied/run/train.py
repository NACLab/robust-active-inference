...
Description: This contain the function API handling logic for training.
  Adapted from Dreamerv3 codebase

NOTE: Implemting look back and related training logic specifically for active inference agent
"""
...
def train_augmented(agent, env, replays, logger, args):
